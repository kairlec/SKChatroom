...
public class RSACoder {
     ...
     * @throws Exception
     */
    public static String decryptByPrivateKeyToString(String data, String key) throws Exception {
    ...
    public static String decryptByPublicKeyToString(String data, String key) throws Exception {
     ...
     * @throws Exception
     */
    public static String encryptByPublicKeyToString(String data, String key)
            throws Exception {
     ...
     * @throws Exception
     */
    public static String encryptByPrivateKeyToString(String data, String key)
            throws Exception {
